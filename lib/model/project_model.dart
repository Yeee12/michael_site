class Project {
  ...
  Project(this.name, this.description, this.image, this.link, this.googleDrive);
}
...
List<Project> projectList = [
  Project(
      ...
      "https://drive.google.com/file/d/1fz1716yvbT9739Aa6wmCdKJtb_I1_6q6/view?usp=drive_link"
  ),
  Project(
      'Fitness App',
  ...
  Project(
      ...
      "",
      "",
    "https://drive.google.com/file/d/1gLvqeeTgdwoAcoRCvBNaoKHMDFjBsY25/view?usp=drive_link"
  )
];
